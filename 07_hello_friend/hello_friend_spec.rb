...
#     ./friend_spec.rb:5:
#
# This means that while it found the file, and it found the class, it couldn't
# find the method named "greeting".
#
...
#     ./friend_spec.rb:5:
#
# This means that there is a method, but it's not returning anything! ("nil" is
# the Ruby way of saying "not anything".)
#
# ## Make it return something
#
# Inside the "greeting" method, put a single line containing a string that is
...
#
# Hint 1: in order to get the next test to pass, you will need to pass a
# *parameter*:
#
#     def greeting(who)
#
# Hint 2: once you do that, the **first** test might start failing again. To
# fix both at the same time, you need to provide a **default value** for that
# parameter:
#
